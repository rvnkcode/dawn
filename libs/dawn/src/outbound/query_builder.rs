...
mod tests {
    ...
    fn empty_filter_returns_order_only() {
        ...
        let (clause, params) = QueryBuilder::build_where_clause(&filter).unwrap();
    ...
    fn repeat_vars_single() {
        assert_eq!(QueryBuilder::repeat_vars(1), "?");
    }

    #[test]
    fn repeat_vars_multiple() {
        assert_eq!(QueryBuilder::repeat_vars(3), "?,?,?");
    }

    #[test]
    #[should_panic]
    fn repeat_vars_zero_panics() {
        QueryBuilder::repeat_vars(0);
    }
}
