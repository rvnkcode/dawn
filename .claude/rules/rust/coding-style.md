...
- **rustfmt** for enforcement — always run `cargo fmt --all` before committing
- **clippy** for lints — `cargo clippy --workspace --all-targets -- -D warnings` (treat warnings as errors)
