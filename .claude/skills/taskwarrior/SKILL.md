...
1. **Local clone** (check first): `~/Downloads/taskwarrior`
2. **GitHub** (fallback): <https://github.com/GothenburgBitFactory/taskwarrior>

### Documentation

- Official Docs: <https://taskwarrior.org/docs/>
- Man Pages: `man task` or `~/Downloads/taskwarrior/doc/man/`

### Key Source Files

| Path           | Contents                                 |
| -------------- | ---------------------------------------- |
| `src/Task.h`   | Task class declaration, Status enum      |
| `src/Task.cpp` | Task implementation                      |
| `src/columns/` | Column classes for each attribute        |
| `doc/man/`     | Man page sources                         |
...
| [confirmation.md](confirmation.md)             | Per-command prompt/permission/exit-code flow   |
